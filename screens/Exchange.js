    ...
    if (this.state.IsExchangeRequestActive === true){
      return(
        ...
        <View style = {{flex:1,justifyContent:'center'}}>
         ...
         <TouchableOpacity style={{width:"75%",height:50,margin:20,alignSelf:'center',justifyContent:'center',alignItems:'center',borderRadius:10,backgroundColor:"#ff5722",shadowColor: "#000",shadowOffset:{width: 0,height: 8,},shadowOpacity: 0.44,shadowRadius: 10.32,elevation: 16,}}
         onPress={()=>{
           this.sendNotification()
           this.updateExchangeRequestStatus();
           this.receivedItem(this.state.requestedItemName)
         }}>
         <Text style={{fontSize: 15, fontWeight: 'bold'}}>I recieved the Item </Text>
         </TouchableOpacity>
       </View>
      </View>
     )
